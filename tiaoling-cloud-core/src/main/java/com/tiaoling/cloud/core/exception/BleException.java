package com.tiaoling.cloud.core.exception;
...
public class BleException extends RuntimeException {
    ...
    public BleException(){}
    public BleException(String message) {super(message);}
    public BleException(String message,Throwable cause){super(message,cause);}
