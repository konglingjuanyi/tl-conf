                    ...
                    <div class="col-xs-4">
                        <div class="input-group">
                            ...
                            <select class="form-control" id="nodeGroup" >
								...
								<#list ConfGroup as group>
									<option value="${group.groupKey}" >${group.groupName}</option>
								</#list>
                            </select>
                        </div>
                    </div>
		                    ...
		                    <tbody>
		                    	<#if fileterData?exists>
		                    		<#list fileterData as item>
		                    			<tr>
					                        <td>${item.nodeKey}</td>
					                        <td <#if item.nodeValue != item.nodeValueReal>style="color:red;font: italic bold"</#if> >${item.nodeValue}</td>
					                        <td <#if item.nodeValue != item.nodeValueReal>style="color:red;font: italic bold"</#if> >${item.nodeValueReal}</td>
					                        <td>${item.nodeDesc}</td>
					                        <td>
					                        	<div class="input-group">
						                      		<button class="btn btn-primary btn-xs update" type="button" nodeKey="${item.nodeKey}" znodeValue="${item.nodeValue}" znodeDesc="${item.nodeDesc}" >更新</button>&nbsp;
